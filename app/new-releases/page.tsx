...
export default function NewReleasesPage() {
  ...
  const newReleasesCategory = getCategoryBySlug('new-releases') || getCategoryBySlug('new')
  ...
  useEffect(() => {
    setCurrentPage(1)
    setAllGames([])
  }, [newReleasesCategory?.id, providerId, searchTerm])
          ...
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm mt-1">
                {meta ? `${meta.total} newly released games` : 'Loading...'}
              </p>
            </div>
          </div>
